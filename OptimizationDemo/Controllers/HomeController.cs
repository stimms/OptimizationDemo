...
namespace OptimizationDemo.Controllers
{
    public class HomeController : Controller, IDisposable
    {
        ...
        public ActionResult List(int runtime)
        {
            ViewBag.RunTime = String.Format("{0} {1}", runtime, DateTime.Now);
            return View(context.IceCreams.Take(10));
        }

        public ActionResult Detail()
        {
            return View(context.IceCreams.Include(x => x.Ingredients).First());
        }
